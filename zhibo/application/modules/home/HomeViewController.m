...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor hexColor:@"#FF2828"];
    [self.view addSubview:self.navView];
    
    self.categoryView = [[JXCategoryTitleView alloc] initWithFrame:CGRectMake(0, SYS_STATUSBAR_HEIGHT, SCREEN_WIDTH/2, 35)];
    ...
    [self.categoryView setTitles:@[@"全部", @"关注"]];
...
- (void)viewDidLayoutSubviews {
    ...
    self.listContainerView.frame = CGRectMake(0, self.navView.height, SCREEN_WIDTH, self.view.height-self.navView.height);
}
