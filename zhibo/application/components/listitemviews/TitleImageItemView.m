...
#import "TitleImageItemView.h"

@interface TitleImageItemView ()
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) UIImageView *iconImageView;
@end
@implementation TitleImageItemView
...
- (void)layoutAdjustContents {
    ...
    self.titleLabel.top = self.iconImageView.bottom+4;
}
@end
