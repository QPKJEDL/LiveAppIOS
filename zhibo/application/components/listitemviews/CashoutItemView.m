...
@property (nonatomic, strong) ABUICheckBox *checkBox;
@end
...
- (void)setupAdjustContents {
    ...
    self.checkBox = [[ABUICheckBox alloc] initWithFrame:CGRectMake(0, 0, 20, 20)];
...
- (void)layoutAdjustContents {
    ...
    self.checkBox.left = self.containView.width-15-self.checkBox.width;
    self.checkBox.centerY = self.containView.height/2;
}
