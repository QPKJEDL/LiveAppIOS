...
#define GRAY_COLOR   [UIColor getColor:@"f7f7f7"]
#define IMAGE_GRAY_COLOR   [UIColor getColor:@"f7f7f7"]
#define DARK_COLOR   [UIColor getColor:@"303331"]

#define MAIN_COLOR   [UIColor getColor:@"1db837"]
...
//判断刘海屏
//#define IS_iPhoneX @available(iOS 11.0, *) && UIApplication.sharedApplication.keyWindow.safeAreaInsets.bottom > 0.0
...
#define TI_HEIGHT           (IS_iPhoneX?34:0)
...
#define STATUS_AND_NAV_BAR_HEIGHT                    (SYS_STATUSBAR_HEIGHT+NAVIGATIONBAR_HEIGHT)
